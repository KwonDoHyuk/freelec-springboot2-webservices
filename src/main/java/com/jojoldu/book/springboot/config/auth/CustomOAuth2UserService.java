...
import com.jojoldu.book.springboot.domain.outhuser.UserOauthRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        UserOauth userOauth = saveOrUpdate(attributes);
        ...
        return new DefaultOAuth2User(
                Collections.singleton(new SimpleGrantedAuthority(userOauth.getRoleKey())),
                attributes.getAttributes(),
                attributes.getNameAttributeKey());
    }


    private UserOauth saveOrUpdate(OAuthAttributes attributes) {
        UserOauth userOauth = userOauthRepository.findByEmail(attributes.getEmail())
